if(!App.dom.definedExt('Ext.googlemapv3')){
Ext.define('Ext.googlemapv3',
{
    extend          :'Ext.Panel',
    alias           :'widget.mapgooglev3',
    ...
    {       
            var me=this;
            var defaultPoint=[this.config.latitude,this.config.longitude]
            var myOptions = 
            {                                                               
                center      : new google.maps.LatLng(defaultPoint[0],defaultPoint[1]),
                zoom        : 8,
                mapTypeId   : google.maps.MapTypeId.HYBRID 
            };
            this.map            = new google.maps.Map(Ext.getDom(this.config.owner.final_form.getId()),myOptions); 
           
            marker = new google.maps.Marker(
            {
                position    : new google.maps.LatLng(defaultPoint[0],defaultPoint[1]),
                map         : this.map
            });
